#!/usr/bin/env python3
"""Run the MVAA v35 final Docker inference pipeline."""
...
TASK3_CKPTS = (
    REPO_ROOT / "weights" / "task3_v35" / "resnet34_s42_best.pt",
    REPO_ROOT / "weights" / "task3_v35" / "resnet34_s49_best.pt",
    REPO_ROOT / "weights" / "task3_v35" / "effb4_s42_best.pt",
    REPO_ROOT / "weights" / "task3_v35" / "effb5_s42_best.pt",
    REPO_ROOT / "weights" / "task3_v35" / "effb5_s44_best.pt",
)
TASK3_LOCAL_CKPTS = (
...
TASK3_WEIGHTS = ("0.30", "0.20", "0.20", "0.15", "0.15")
TASK3_THRESHOLD = 0.40
...
def log(message: str) -> None:
    print(f"[final-v35] {message}", flush=True)
...
def main() -> int:
    ...
    work_root = args.work_dir / "mvaa_v35"
