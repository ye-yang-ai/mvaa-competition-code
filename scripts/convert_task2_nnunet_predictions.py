#!/usr/bin/env python3
"""Convert nnU-Net Task2 predictions to MVAA submission format."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mapping-json", type=Path, default=Path("outputs/nnunet_task2_fold0/task2_case_mapping.json"))
...
def main() -> int:
    ...
    output_json = out_dir / "task2_predictions.json"
